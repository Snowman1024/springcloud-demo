...
| seata-order-service        | application.yml                                              | 8180            | @EnableDiscoveryClient   @EnableFeignClients<br />@GlobalTransactional |
| seata-storage-service      | application.yml                                              | 8181            | @EnableDiscoveryClient   @EnableFeignClients                 |
| seata-account-service      | application.yml                                              | 8182            | @EnableDiscoveryClient   @EnableFeignClients                 |
| oauth2-service             | application.yml                                              | 9401            | @EnableAuthorizationServer <br />@EnableResourceServer<br /> @EnableWebSecurity |
| oauth2-jwt-service         | application.yml                                              | 9401            | @EnableAuthorizationServer<br />@EnableResourceServer<br />@EnableWebSecurity |
